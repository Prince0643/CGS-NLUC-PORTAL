...
INSERT INTO `users` (`id`, `id_number`, `email`, `password`, `created_at`, `user_level`, `program_id`, `enrollment_status`) VALUES
(4, '211-1003-1', 'tolentino@gmail.com', '$2b$10$C8T1WMh7VEYNcmz2UEn1yOJQhwfy7vnHXlLCdWBHO10iVLIm8AY4y', '2025-06-24 13:29:30', 'student', NULL, 'not enrolled'),
(6, 'admin02', 'admin2@cgs.edu', '$2b$10$RhVLs/JwrUyGaC/7ZvftD.hggvXtffTUsu4pQrbk8qfnGxhpO3hgy', '2025-06-25 16:26:09', 'admin', NULL, NULL),
(7, '20250001', 'msis.student@cgs.edu', 'password123', '2025-06-28 07:04:15', 'student', NULL, 'not enrolled'),
(11, '211-1001-1', 'tolen@gmail.com', '$2b$10$4kXdclLy1gYvdnslIhhDgelL2lUxdZc8HLU6ObqBlip0IaTvno.Jy', '2025-06-30 07:51:34', 'student', NULL, 'not enrolled');
